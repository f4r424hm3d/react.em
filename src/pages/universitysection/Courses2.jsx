    ...
    <div className="bg-white rounded-xl shadow-md p-6 w-full border border-gray-200 flex flex-col gap-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full">
        <button
          ...
          className={`flex items-center justify-center gap-2 px-4 py-2 rounded-xl border font-medium transition text-sm ${isSelected
                  ...
                  <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                    <button
                      onClick={() => onApplyNow && onApplyNow({
                        ...course,
                        ...(courseDetails || {}),
                        course_name: courseDetails?.course_name || course?.course_name
                      })}
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    {intakeMonths.map((item, index) => {
                      ...
                      return (
                        <div
                          key={index}
                          className={`p-3 text-center rounded-lg border text-sm ${isActive
                            ? 'bg-blue-600 text-white border-blue-600'
                  ...
                  {pagination.last_page > 1 && (
                    <div className="flex justify-center items-center gap-3 mt-6">
                      <button
                        ...
                        className={`w-10 h-10 flex items-center justify-center rounded-full border transition ${page > 1 && !loading
                      ...
                      {[...Array(pagination.last_page)].map((_, i) => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-10 h-10 flex items-center justify-center rounded-full border text-sm font-medium transition ${pageNum === page
                              ? "bg-blue-600 text-white border-blue-600"
                      ...
                      <button
                        ...
                        className={`w-10 h-10 flex items-center justify-center rounded-full border transition ${page < pagination.last_page && !loading
                          ? "border-gray-300 text-gray-600 hover:bg-gray-100"
                          : "border-gray-300 text-gray-400 cursor-not-allowed bg-gray-100"
                          }`}
                      >
