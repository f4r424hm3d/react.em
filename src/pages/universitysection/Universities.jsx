            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="text-sm sm:text-base text-gray-700 font-medium">
                  Showing <span className="font-bold text-blue-600">{indexOfFirstItem + 1}</span>-
                  <span className="font-bold text-blue-600">{Math.min(indexOfLastItem, data.length)}</span> of{' '}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 px-4 py-2.5 rounded-lg font-semibold text-sm transition-all duration-200 ${currentPageNum === 1
                  ...
                  <div className="flex items-center gap-1.5">
                    {[...Array(totalPages)].map((_, index) => {
                      ...
                      if (
                        ...
                        return (
                          <button
                            ...
                            className={`w-10 h-10 sm:w-11 sm:h-11 rounded-lg font-bold text-sm sm:text-base transition-all duration-200 ${currentPageNum === pageNum
                      ...
                      } else if (pageNum === currentPageNum - 2 || pageNum === currentPageNum + 2) {
                        return (
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 px-4 py-2.5 rounded-lg font-semibold text-sm transition-all duration-200 ${currentPageNum === totalPages
                        ? 'bg-gray-100 text-gray-400 cursor-not-allowed'
                        : 'bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 shadow-md hover:shadow-lg transform hover:translate-x-0.5'
                      }`}
                  >
