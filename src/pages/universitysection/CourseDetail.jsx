...
const GetInTouchForm = () => (
  <div className="bg-white p-6 rounded-lg shadow-md">Get in Touch Form</div>
);
const FeaturedUniversities = () => (
  <div className="bg-white p-6 rounded-lg shadow-md">Featured Universities</div>
);
...
const PopularCourses = () => (
  <div className="bg-white p-6 rounded-lg shadow-md">Popular Courses</div>
);
...
const CourseDetail = () => {
  ...
  const handleApplyNow = () => {
    ...
    if (token) {
      // User is logged in - apply immediately
      applyToCourse(courseDetails.id);
    } else {
  ...
  const activeIntakeMonths = new Set(
    courseDetails?.intake?.split(",").map((m) => m.trim().substring(0, 3)),
  );
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          {courseDetails.tuition_fees || "N/A"}
                        </p>
                      </div>
                    </div>
                ...
                <div className="space-y-3">
                        ...
                        <div className="p-4 border-t border-gray-200">
                          <div className="bg-blue-100 p-3 rounded-lg mb-4">
                            <h3 className="text-lg font-medium text-blue-800">
                              Course of {courseDetails.course_name} in{" "}
                  ...
                  <div className="border border-gray-300 rounded-lg bg-gray-50">
                    ...
                    {expandedSections.programme &&
                      courseDetails.programme_structure && (
                        <div className="p-4 border-t border-gray-200 bg-white">
                          <div
                            className="space-y-4 text-gray-700"
                            dangerouslySetInnerHTML={{
                              __html: courseDetails.programme_structure || "",
                            }}
                          />
                        </div>
                      )}
                  ...
                  {courseDetails.similar_programs &&
                    courseDetails.similar_programs.length > 0 && (
                      <div className="border border-gray-300 rounded-lg bg-gray-50">
                        <button
                        ...
                        {expandedSections.similarPrograms && (
                          <div className="p-4 border-t border-gray-200 bg-white">
                            <div className="space-y-6">
                              {courseDetails.similar_programs.map(
                                (program, index) => (
                                  <div
                                    key={index}
