...
const UniversityDetailPage = () => {
  ...
  const [activeTab, setActiveTab] = useState(
    courseSlug ? "courses" : section || "overview"
  ); // ✅ Agar courseSlug hai toh courses tab active karo
    ...
    const fetchUniversityData = async () => {
      ...
      try {
        ...
        const mergedData = {
          ...
          offeredCourses: STATIC_OFFERED_COURSES,
          clicks: fetchedData.click || fetchedData.clicks || fetchedData.views || "N/A",
  ...
  return (
    <>
              ...
              <div className="col-span-2 space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                  ...
                  <div className="bg-white rounded-lg shadow-sm py-2 px-3 flex flex-col items-center text-center">
                    ...
                    <h3 className="text-base font-bold leading-tight">{universityData.established || "1970"}</h3>
                  ...
                  <div className="bg-white rounded-lg shadow-sm py-2 px-3 flex flex-col items-center text-center">
                    ...
                    <h3 className="text-base font-bold leading-tight">{universityData.Scholarship ? "Yes" : "No"}</h3>
                  ...
                  <div className="bg-white rounded-lg shadow-sm py-2 px-3 flex flex-col items-center text-center">
                    ...
                    <h3 className="text-base font-bold leading-tight">{universityData.clicks}</h3>
                  ...
                  <div className="bg-white rounded-lg shadow-sm py-2 px-3 flex flex-col items-center text-center">
                    ...
                    <h3 className="text-base font-bold leading-tight">{universityData.courses || "N/A"}</h3>
      ...
      {/* Tabs */}
      <div className="bg-white border-b shadow-sm -mt-4 sticky top-14 z-50">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 flex overflow-x-auto hide-scrollbar">
          {getFilteredTabs().map((tab) => (
            <button
              key={tab.id}
              onClick={() => handleTabChange(tab.id)}
              className={`py-4 px-6 text-sm font-medium transition-all border-b-2 cursor-pointer whitespace-nowrap ${activeTab === tab.id
      ...
      {activeTab === "courses" ? (
        <div id="courses-section" className="py-4">
          <Courses courseSlug={courseSlug} /> {/* ✅ courseSlug pass karo */}
        </div>
      ) : (
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-4 grid grid-cols-1 lg:grid-cols-3 gap-8">
