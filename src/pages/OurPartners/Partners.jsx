...
function Partners() {
    ...
    const countries = ['All Countries', ...Array.from(new Set(partners.map(p => p.country || 'India'))).sort()];
    const states = selectedCountry === 'All Countries'
        ? ['All States', ...Array.from(new Set(partners.map(p => p.state))).sort()]
        : ['All States', ...Array.from(new Set(partners.filter(p => (p.country || 'India') === selectedCountry).map(p => p.state))).sort()];

    const cities = selectedState === 'All States'
        ? ['All Cities', ...Array.from(new Set(partners.filter(p => selectedCountry === 'All Countries' || (p.country || 'India') === selectedCountry).map(p => p.city))).sort()]
        : ['All Cities', ...Array.from(new Set(partners.filter(p => p.state === selectedState && (selectedCountry === 'All Countries' || (p.country || 'India') === selectedCountry)).map(p => p.city))).sort()];
    ...
    const filteredPartners = useMemo(() => {
        return partners.filter(partner => {
            ...
            const matchesCountry = selectedCountry === 'All Countries' || (partner.country || 'India') === selectedCountry;
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <div className="flex items-center justify-center mb-6">
                            <MapPin className="w-8 h-8 text-cyan-300 mr-3" />
                            <span className="text-cyan-100 text-lg font-medium">India Network</span>
                        </div>

                        <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
                            Our <span className="text-cyan-300">Partners</span> in India
                        </h1>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
                            <div className="text-center">
                                <div className="text-4xl font-bold text-cyan-300 mb-2">{totalStats.totalPartners}+</div>
                                <div className="text-blue-100">Trusted Partners</div>
                            </div>
                            <div className="text-center">
                                <div className="text-4xl font-bold text-cyan-300 mb-2">{totalStats.totalStudents}+</div>
                                <div className="text-blue-100">Students Placed</div>
                            </div>
                            <div className="text-center">
                                <div className="text-4xl font-bold text-cyan-300 mb-2">{totalStats.averageRating}</div>
                                <div className="text-blue-100">Average Rating</div>
                            </div>
                            <div className="text-center">
                                <div className="text-4xl font-bold text-cyan-300 mb-2">{totalStats.states}</div>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-lg">
                        ...
                        <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-200">
                            <div className="text-gray-600">
                                Showing <span className="font-semibold text-blue-600">{filteredPartners.length}</span> partners
                            </div>
                                                ...
                                                <div className="p-6">
                                                    <div className="flex items-start justify-between mb-4">
                                                        <div>
                                                            ...
                                                            <p className="text-blue-600 font-medium">{partner.designation}</p>
                                                    ...
                                                    <div className="grid grid-cols-2 gap-4 mb-4 text-center">
                                                        <div className="bg-blue-50 rounded-lg p-3">
                                                            <div className="text-2xl font-bold text-blue-600">{partner.studentsPlaced}</div>
                                            ...
                                            <>
                                                ...
                                                <div className="flex-1 grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                                                    <div>
                                                        ...
                                                        <p className="text-blue-600 font-medium text-sm">{partner.designation}</p>
                                                        <p className="text-gray-600 text-sm">{partner.company}</p>
                                                    </div>
                                                    ...
                                                    <div className="text-center">
                                                        <div className="text-lg font-bold text-blue-600">{partner.studentsPlaced}</div>
                                                        <div className="text-xs text-gray-600">Students Placed</div>
