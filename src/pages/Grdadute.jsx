          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button onClick={() => scrollToSection('apply')} className="bg-white text-blue-600 px-8 py-4 rounded-lg hover:bg-blue-50 transition-all transform hover:scale-105 shadow-lg font-medium flex items-center justify-center gap-2">
                  Start Your Application
                  <ArrowRight className="w-5 h-5" />
                </button>
                <button onClick={() => scrollToSection('eligibility')} className="bg-transparent text-white px-8 py-4 rounded-lg hover:bg-white/10 transition-all border-2 border-white font-medium">
                  Check Eligibility
                </button>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-bold text-slate-800 mb-2">Multiple Entry Visa (MEV)</h3>
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-bold text-slate-800 mb-2">Dependent Graduate Pass</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-bold text-slate-800 mb-2">Part-Time Work Allowed</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
              ...
              <div className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-lg font-bold text-slate-800 mb-2">12-Month Validity</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-4">
                <div className="flex gap-4 p-4 bg-blue-50 rounded-xl border-2 border-blue-100">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-800 mb-1">Bachelor's Degree or Higher</h3>
                    <p className="text-slate-600">Completed from a recognized Malaysian institution</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 bg-blue-50 rounded-xl border-2 border-blue-100">
                  <CheckCircle className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold text-slate-800 mb-1">Valid Student Pass</h3>
                    <p className="text-slate-600">Must be active at the time of application</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 bg-blue-50 rounded-xl border-2 border-blue-100">
                  <CheckCircle className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold text-slate-800 mb-1">Passport Validity</h3>
                    <p className="text-slate-600">Must be valid for at least 18 months from application date</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 bg-blue-50 rounded-xl border-2 border-blue-100">
                  <CheckCircle className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold text-slate-800 mb-1">Graduation Confirmation</h3>
                    <p className="text-slate-600">Letter from institution confirming completion or expected graduation date</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 bg-blue-50 rounded-xl border-2 border-blue-100">
                  <CheckCircle className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold text-slate-800 mb-1">Health Insurance</h3>
                    <p className="text-slate-600">Active coverage for the full Graduate Pass duration (1 year)</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 bg-blue-50 rounded-xl border-2 border-blue-100">
                  <CheckCircle className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold text-slate-800 mb-1">Malaysian Sponsor</h3>
                    <p className="text-slate-600">Personal bond and Malaysian citizen sponsor with minimum monthly salary of RM 1,500</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 bg-blue-50 rounded-xl border-2 border-blue-100">
                  <CheckCircle className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold text-slate-800 mb-1">Clean Legal Record</h3>
                    <p className="text-slate-600">No legal convictions in Malaysia</p>
                  </div>
                </div>
              </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-xl">
      ...
      <div className="mt-6 text-center">
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="mt-6 p-4 bg-blue-50 border-2 border-blue-200 rounded-xl">
                <div className="flex gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-800 mb-2">For Dependents</h3>
                    <p className="text-slate-700 leading-relaxed">
                ...
                <div className="space-y-6">
                  <div className="relative flex gap-6">
                    ...
                    <div className="flex-1 pt-2">
                      <h3 className="text-xl font-bold text-slate-800 mb-2">Confirm Eligibility</h3>
                      <p className="text-slate-600 leading-relaxed">Verify degree completion, Student Pass status, and passport validity</p>
                    </div>
                  </div>
                  ...
                  <div className="relative flex gap-6">
                    ...
                    <div className="flex-1 pt-2">
                      <h3 className="text-xl font-bold text-slate-800 mb-2">Gather Documents</h3>
                      <p className="text-slate-600 leading-relaxed">Prepare graduation letter, insurance, sponsor & bond documents, and photos</p>
                    </div>
                  </div>
                  ...
                  <div className="relative flex gap-6">
                    ...
                    <div className="flex-1 pt-2">
                      <h3 className="text-xl font-bold text-slate-800 mb-2">Apply via EMGS</h3>
                      <p className="text-slate-600 leading-relaxed">Submit application and supporting documents through the EMGS portal</p>
                    </div>
                  </div>
                  ...
                  <div className="relative flex gap-6">
                    ...
                    <div className="flex-1 pt-2">
                      <h3 className="text-xl font-bold text-slate-800 mb-2">Receive Decision</h3>
                      <p className="text-slate-600 leading-relaxed">EMGS/Immigration will review and issue approval if eligible</p>
                    </div>
                  </div>
                  ...
                  <div className="relative flex gap-6">
                    ...
                    <div className="flex-1 pt-2">
                      <h3 className="text-xl font-bold text-slate-800 mb-2">Entry & Compliance</h3>
                      <p className="text-slate-600 leading-relaxed">Keep printed and digital copies of your Visa Approval Letter and comply with all pass conditions</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section id="apply" className="py-8 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
