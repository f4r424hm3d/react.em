            ...
            <div className="hidden lg:flex lg:w-1/2 bg-blue-600 relative overflow-hidden flex-col justify-between p-16 text-white text-left">
                ...
                <div className="relative z-10 animate-fade-in-right">
                    ...
                    <h1 className="text-5xl font-extrabold leading-tight mb-6 tracking-tight">
                        Lost Your <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-white">Password?</span>
                    </h1>
                    <p className="text-lg text-blue-100 max-w-lg leading-relaxed font-light">
                        No worries! It happens to the best of us. Enter your email and we'll help you reset it in no time.
                    </p>
                </div>

                <div className="relative z-10 mt-auto pt-10 border-t border-white/10">
                    <p className="text-sm font-medium text-blue-100">Need help? Contact support at support@educationmalaysia.com</p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 relative bg-white">
                <div className="w-full max-w-md space-y-8 animate-fade-in-up">
                    ...
                    <div className="text-center lg:text-left">
                        <Link to="/login" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-blue-600 mb-6 transition-colors">
                            <FaArrowLeft size={12} /> Back to Login
                        </Link>
                        <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Recover Account</h2>
                        <p className="mt-2 text-gray-500">Enter your registered email address.</p>
                    </div>
...
// Modern Clean Input
const ModernInput = ({ label, type, name, placeholder, value, onChange, icon, required }) => (
