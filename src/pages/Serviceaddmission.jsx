...
function ProcessStep({ number, title, description, icon: Icon, duration, isLast }) {
  return (
    <motion.div
    ...
    >
      <p className="text-slate-700 text-xs flex items-start gap-2">
        ...
        <span className="font-medium">
          <span className="font-semibold text-amber-900">Important Note:</span> Start the renewal process 2–3 months before your current pass expires.
        </span>
      </p>
    </motion.div>
  </div>
...
>
  <div className="flex items-center justify-center gap-3">
    ...
    <p className="text-slate-600 text-xs md:text-sm text-center">
      This guide provides general info about the <span className="font-semibold">Malaysian student visa</span>. Always verify requirements with your institution and EMGS.
    </p>
  </div>
</motion.footer>
